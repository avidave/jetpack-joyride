 ...
 * Mr. Conway
 * 
 * Program Description: The program is based off a game called Jetpack Joyride. 
 * 
 ...
 *  
 * Jetpack (Main Class): This is the main class of the program. This class handles the structure of the program. It uses both the LaserGen and MissileGen classes in order to 
...
public class Jetpack_Main extends JPanel implements ActionListener, KeyListener{
	
	private static final long serialVersionUID = 1L;
	
	// Declaring global variables
	
	// Integers that store x and y positions of objects, number of metres, choices, counts, etc.
	...
	// LaserGen object
	private LaserGen lg;
	// Booleans to check if a statement is true or false
	...
	// Player skins ImageIcon array - with and without jetpack boost 
